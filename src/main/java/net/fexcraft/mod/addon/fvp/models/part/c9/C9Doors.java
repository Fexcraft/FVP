...
public class C9Doors extends PartModel {
	...
	public C9Doors(){
		...
		door_front_left.add(new ModelRendererTurbo(door_front_left, 353, 217, textureX, textureY)
			...
			.setRotationPoint(17, 3.9f, 17.5f).setRotationAngle(-46.000004f, 0, 0).setName("Box 465")
		);
		...
		door_front_left.addPrograms(new DefaultPrograms.AttributeRotator("c9_doors_fl", true, 0, 60, 0.5f, 1, 0f, false), DefaultPrograms.RGB_PRIMARY);
		...
		door_front_left_mirror.addPrograms(new DefaultPrograms.AttributeRotator("c9_doors_fl", true, 0, 60, 0.5f, 1, 0f, false));
		...
		door_front_right.add(new ModelRendererTurbo(door_front_right, 353, 225, textureX, textureY)
			...
			.setRotationPoint(17, 3.9f, -19.5f).setRotationAngle(-45, 0, 0).setName("Box 481")
		);
		...
		door_rear_right.add(new ModelRendererTurbo(door_rear_right, 121, 209, textureX, textureY)
			...
			.setRotationPoint(-8, 3.8f, -19.5f).setRotationAngle(-45, 0, 0).setName("Box 525")
		);
