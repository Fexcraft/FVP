//FMT-Marker FVTM-1.1
package net.fexcraft.mod.addon.fvp.models.part.c4;
 ...
 */
@fModel(registryname = "fvp:models/part/c4r1_wheel")
public class C4R1Wheel extends PartModel {
	...
	public C4R1Wheel(){
		...
		wheel.add(new ModelRendererTurbo(wheel, 266, 20, textureX, textureY).addCylinder(0, 0, 0, 3, 3, 16, 1, 1, 1, null));
		wheel.add(new ModelRendererTurbo(wheel, 468, 4, textureX, textureY).addHollowCylinder(0, 0, 4, 9, 6, 1, 16, 0, 0.9375f, 1, 1, null));
		wheel.add(new ModelRendererTurbo(wheel, 0, 0, textureX, textureY).addHollowCylinder(0, 0, 0, 9, 6, 1, 16, 0, 0.9375f, 1, 0, null));
