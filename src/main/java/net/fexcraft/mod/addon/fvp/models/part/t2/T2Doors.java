...
public class T2Doors extends PartModel {
	...
	public T2Doors(){
		...
		door_left.addPrograms(DefaultPrograms.RGB_PRIMARY, new DefaultPrograms.AttributeRotator("t2_door_left", true, 0, 80, 0.5f, 1, 0f));
		...
		door_right.addPrograms(DefaultPrograms.RGB_PRIMARY, new DefaultPrograms.AttributeRotator("t2_door_right", true, -80, 0, -0.5f, 1, 0f));
